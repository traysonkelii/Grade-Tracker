...
//form builder
Route::post('/form/createFormAttribute/{name}/{desc}/{type}/{scope}/{max}/{min}/{selections}/{person}', 'FormBuilderController@createFormAttribute')->name('formCreateAttributes');
